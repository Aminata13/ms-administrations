package com.safelogisitics.gestionentreprisesusers.data.dao.jsonSerializer;
  ...
  public void serialize(Compte compte, JsonGenerator jsonGenerator, 
    ...
    JsonProcessingException {
      if (!compte.isDeleted()) {
        ...
        jsonGenerator.writeObjectField("serviceConciergeries", compte.getServiceConciergeries() != null ? compte.getServiceConciergeries() : null);
