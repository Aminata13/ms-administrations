...
public class RegisterRequest extends InfosPersoRequest {
  ...
  public RegisterRequest(String prenom, String nom, String email, String telephone, String username, String password, String adresse, LocalDate dateNaissance, String anneeNaissance, String numeroPermis, String numeroPiece, String photoProfil) {
    this.prenom = prenom;
    this.nom = nom;
    this.email = email;
    this.telephone = telephone;
