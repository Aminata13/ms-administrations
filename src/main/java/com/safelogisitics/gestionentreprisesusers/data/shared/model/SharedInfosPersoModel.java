...
public class SharedInfosPersoModel extends AuditMetadata {
  ...
  public void setComptes(ObjectMapper objectMapper,
      Set<com.safelogisitics.gestionentreprisesusers.data.model.Compte> dataComptes) {
    this.comptes = new HashSet<Compte>();
    dataComptes.forEach(compte -> this.comptes.add(objectMapper.convertValue(compte, Compte.class)));
  }
