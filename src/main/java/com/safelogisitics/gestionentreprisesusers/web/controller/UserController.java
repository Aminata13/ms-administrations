...
public class UserController {
    ...
    public ResponseEntity<?> getByEmailOrTelephone(@PathVariable(value = "emailOrTelephone") String emailOrTelephone, @RequestParam(required = false) Boolean prestation) {
        return ResponseEntity.status(HttpStatus.OK).body(infosPersoService.findByEmailOrTelephone(emailOrTelephone, prestation));
    }
